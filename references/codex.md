...
Resolve scripts relative to the skill root containing SKILL.md (the parent of this references directory). Do not use Claude-specific variables or assume the project directory is the skill directory. The usual location is $CODEX_HOME/skills/deepseek-subagent, or ~/.codex/skills/deepseek-subagent when CODEX_HOME is unset.
